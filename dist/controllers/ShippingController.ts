...
class ShippingsController {
    ...
    async index(req: Request, res: Response, next: any) {
        try {
            const isCheck: any = await checkEmployeeRights(req, "ViewShipping");
    ...
    async createShipping(req: Request, res: Response, next: any) {
        try {
            const isCheck: any = await checkEmployeeRights(req, "CreateShipping");
            const { roles, ...orther } = isCheck
            if (isCheck?.status) {
    ...
    async deleteShipping(req: Request, res: Response, next: any) {
        try {
            const isCheck: any = await checkEmployeeRights(req, "DeleteShipping");
            const { roles, ...orther } = isCheck
            if (isCheck?.status) {
                const { id } = req.params;
